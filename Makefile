...
SERVER_OBJS := server/main.o server/server.o server/server_tui.o common/socket.o common/tui.o server/user_sockets.o
CLIENT_OBJS := client/main.o client/client.o client/client_tui.o common/socket.o common/tui.o
